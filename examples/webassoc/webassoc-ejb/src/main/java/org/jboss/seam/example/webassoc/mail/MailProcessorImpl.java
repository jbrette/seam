        ...
        implements MailProcessor
{
   ...
   public void sendAlert(String email, String msgTitle)
   {
      ...
      try
      {
         ...
         Contexts.getEventContext().set("doNotReplyAddr",
            Cts.DO_NOT_REPLY_ADDR);
         Contexts.getEventContext().set("doNotReplyName",
            Cts.DO_NOT_REPLY_NAME);
         Contexts.getEventContext().set("bccSecretary", Cts.SECRETARY);
   ...
   */
   ...
   // REGISTRATION
   //================================================================================
   public void sendActivation(String userName, String userEmail,
      String userPasssword)
   {

      String msgName = "Activation";

      try
      {

         Contexts.getEventContext().set("regUserName", userName);
         Contexts.getEventContext().set("regUserEmail", userEmail);
         Contexts.getEventContext().set("regUserPasssword", userPasssword);
         Contexts.getEventContext().set("doNotReplyAddr",
            Cts.DO_NOT_REPLY_ADDR);
         Contexts.getEventContext().set("doNotReplyName",
            Cts.DO_NOT_REPLY_NAME);
         ...
         if (REALLY_SENT_MAIL)
         {
            ...
            Renderer.instance().render("/mailing/activation.xhtml");
      ...
      catch (FacesException e)
      {
         ...
         facesMessages.add("Sending e-mail failed for [" + userName + "]["
            + userEmail + "]");
         log.error("Error sending " + msgName + " e-mail for [" + userName
            + "][" + userEmail + "]");
   ...
   public void sendPasswordReset(String userName, String userEmail,
      String userPasssword)
   {

      String msgName = "PassswordReset";
      ...
      try
      {
         ...
         if (REALLY_SENT_MAIL)
         {
            ...
            Renderer.instance().render("/mailing/password_reset.xhtml");
   ...
   public void sendAccountInit(String userName, String userEmail,
      String userPasssword)
   {

      String msgName = "AccountInit";
      ...
      try
      {
         ...
         if (REALLY_SENT_MAIL)
         {
            ...
            Renderer.instance().render("/mailing/account_init.xhtml");
   ...
   public void sendMembership(AssocMember amember)
   {
      ...
      try
      {
         ...
         Contexts.getEventContext().set("doNotReplyName",
            Cts.DO_NOT_REPLY_NAME);
         Contexts.getEventContext().set("bccSecretary", Cts.SECRETARY);
         Contexts.getEventContext().set("bccAccounting", Cts.ACCOUNTING);

         if (REALLY_SENT_MAIL)
         {

            Renderer.instance().render("/mailing/membership.xhtml");
