...
public interface Cts
{
   ...
   public static final String MAILING_QUEUE = "queue/mailingQueue";

   // Address used for the mailing
   public static final String DO_NOT_REPLY_NAME = "DallasAccueil";
   public static final String DO_NOT_REPLY_ADDR = "do-not-reply@dallasaccueil.com";

   // Address used for the secretary
   public static final String SECRETARY = "secretaire@dallasaccueil.org";

   // Address used for the secretary
   public static final String ACCOUNTING = "comptable@dallasaccueil.org";
   
   // Address used for the contact
   public static final String CONTACT_US = "contact@dallasaccueil.org";

   // main home page
   public static final String HOME_PAGE = "www.dallasaccueil.org";

   // Address used for the mailing
   public static final String PROJECT_NAME = "Dallas Accueil";

   // Default Skin
   public static final String DFLT_SKIN = "webassoc";
   ...
   public interface GMAP
   {
      ...
      public static final String KEY_WWW_DALLASACCUEIL_COM =
         "ABQIAAAAofyPr7f10fiGr5aoCS4eQRSWpBIdyVTqI-88QvpscUDMvj4PVBTbOnnIwDz4GBPgC-GT2J-gBAWE9w";

      // www.dallasaccueil.org
      public static final String KEY =
         "ABQIAAAAofyPr7f10fiGr5aoCS4eQRSzTovzad_t515Yxxu167XaREJhZxSA85cTynVzEk6nNV_AcST_rtFU9Q";
   ...
   public interface IPs
   {
      ...
      // LINUX ENVIRONMENT
      public static final String UGLYSERVERNAME = "www.dallasaccueil.org";

      // WAR NAME
      public static final String UGLYWARNAME = "seam-webassoc";
   ...
   public interface Dflt
   {
      ...
      public static final String E_MAIL = "assocName@dallasaccueil.org";
