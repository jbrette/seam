...
public interface Cts
{
   ...
   public static final String MAILING_QUEUE = "queue/showcaseMailingQueue";

   // Address used for the mailing
   public static final String DO_NOT_REPLY = "donotreply@alemaxdesign.com";

   // Address used for the secretary
   public static final String SECRETARY = "contact@alemaxdesign.com";

   // Address used for the contact
   public static final String CONTACT_US = "contact@alemaxdesign.com";

   // main home page
   public static final String HOME_PAGE = "www.alemaxdesign.com";

   // Address used for the mailing
   public static final String PROJECT_NAME = "ALEMAX Design";

   // Default Skin
   public static final String DFLT_SKIN = "showcase";
   ...
   public interface GMAP
   {
      ...
      // www.alemaxdesign.com
      public static final String KEY =
         "ABQIAAAAofyPr7f10fiGr5aoCS4eQRSFuU9JRcXozkcmRlLyCHRZGiWR5hRhJIp8UO8XNK1gOCs8faLLOyFK-Q";
   ...
   public interface IPs
   {
      ...
      // LINUX ENVIRONMENT
      public static final String UGLYSERVERNAME = "www.alemaxdesign.com";

      // WAR NAME
      public static final String UGLYWARNAME = "seam-showcase";
   ...
   public interface Dflt
   {
      ...
      public static final String E_MAIL = "assocName@alemaxdesign.com";
